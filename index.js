...
const express = require('express'); // रेंडर के लिए ज़रूरी
const app = express();

// --- 🌐 रेंडर के लिए वेब सर्वर (ताकि Failed न हो) ---
app.get('/', (req, res) => res.send('Bot is Running!'));
app.listen(process.env.PORT || 3000);

// --- 🤖 बॉट सेटअप ---
// यह टोकन रेंडर की सेटिंग से उठाएगा, अगर वहां नहीं है तो आपका वाला इस्तेमाल करेगा
...
// --- 🛡️ आपका गेम डेटाबेस (जो आपने भेजा था) ---
const games = {
    "ALL_MARKET_CHART": `
